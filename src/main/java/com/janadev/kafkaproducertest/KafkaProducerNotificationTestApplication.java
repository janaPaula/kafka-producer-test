...
public class KafkaProducerNotificationTestApplication implements CommandLineRunner {

	@Autowired
	private ProducerService producerService;

	public static void main(String[] args) {
		SpringApplication.run(KafkaProducerNotificationTestApplication.class, args);
	}
	...
	public void run(String... args) throws Exception {
		...
		producerService.sendNotificationMessageToKafkaTopic();
	}
}
